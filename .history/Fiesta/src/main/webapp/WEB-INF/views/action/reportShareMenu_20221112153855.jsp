...
<div class="report-menu-container" id="feedMenu">
  <div class="report-menu">
    <div class="report-menu-btn btn1"><button id="feedReportBtn">신고</button></div>
    <div class="report-menu-btn btn2"><button id="feedShareBtn">공유하기</button></div>
