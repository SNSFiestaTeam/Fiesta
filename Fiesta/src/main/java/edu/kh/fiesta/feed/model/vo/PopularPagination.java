...
public class PopularPagination {
   ...
   public PopularPagination(int listCount, int currentPage) {
   ...
   public PopularPagination(int listCount, int currentPage, int limit, int pageSize) {
      this.listCount = listCount;
      this.currentPage = currentPage;
      this.limit = limit;
