package edu.kh.fiesta.search.model.vo;
...
public SearchPagination(int listCount, int currentPage) {
...
public SearchPagination(int listCount, int currentPage, int limit, int pageSize) {
   this.listCount = listCount;
   this.currentPage = currentPage;
   this.limit = limit;
