          ...
          <!-- 피드 리스트 -->
                ...
                <div class="profile-image-area">
                  ...
                  <div class="feed-header">
                    ...
                    <%--     </c:if> --%>
                      ...
                      <a href="/feed/${board.memberNickname}" class="feed-memberId">user001</a>
                    </div>
                    <div>
              ...
              <%--       <c:if test="${board.likeCheck == 0}"> --%>
                  ...
                  <div class="main-container">
                    ...
                    <div class="like-count">좋아요 <span class="board-like-count">1</span>개</div>
                   <%--  </c:if>
                    ...
                    <div class="feed-main-content">
                      <div class="feed-content one-line">
                        <a href="/feed/${board.memberNickname}"><span class="member-id">user001</span></a>
