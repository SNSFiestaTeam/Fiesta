      ...
      $.ajax({
        ...
        success: (commentList) => {
          for (let i = 0; i < commentList.length; i++) {
            ...
            commentFirstLine.append(div4, div5);
            ...
            div4.append(memberIdArea, commentContent);

            // div2에 button.comment-like-btn 추가
            const likeBtn2 = document.createElement("button");
            likeBtn2.classList.add("comment-like-btn");
            const heart = document.createElement("i");
            heart.classList.add("fa-regular", "fa-heart");
            ...
            likeBtn2.addEventListener("click", () => {
              ...
              if (!likeBtn2.classList.contains("red")) {
                likeBtn2.innerHTML = "";
                likeBtn2.innerHTML = solidHeart;
                likeBtn2.classList.add("red");
              } else {
                likeBtn2.innerHTML = emptyHeart;
                likeBtn2.classList.remove("red");
              }
            });
