...
function createBoard(board) {
  ...
  for (let comment of board.commentList) {
    if (comment.upperCommentNo != undefined) {
      ...
      const commentFirsrLine = document.createElement("div");
      commentFirsrLine.classList.add("comment-firstLine");

      commentFirstChild.append(commentProfileA, commentFirsrLine);
      ...
      commentFirsrLine.append(commentDiv3, commentDiv4);
      ...
      commentFirsrchild.append(commentFirsrLine, commentDiv5);
    }
  }
