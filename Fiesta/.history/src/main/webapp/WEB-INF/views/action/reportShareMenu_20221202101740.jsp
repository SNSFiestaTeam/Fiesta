...
<div class="feed-menu-container-login" id="feedMenuLogin">
  <div class="feed-menu-login">
    ...
    <div class="feed-menu-btn-login btn3"><button id="feedShareBtnLogin">좋아요 수 숨기기</button></div>
    <div class="feed-menu-btn-login btn3"><button id="feedShareBtnLogin">댓글 기능 해제</button></div>
    <div class="feed-menu-btn-login btn3"><button id="feedShareBtnLogin">게시물로 이동</button></div>
