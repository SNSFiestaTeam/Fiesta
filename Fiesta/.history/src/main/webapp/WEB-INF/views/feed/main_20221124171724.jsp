              ...
              <div class="feed">
                ...
                <div class="main-content-section">
                                    ...
                                    <div>
                                      <div class="comment-firstline">
                                        ...
                                        <div>
                                          ...
                                          <button class="comment-like-btn"><i class="fa-solid fa-heart red"></i></button>
                                          </c:if>
                  ...
                  <div class="comment-input-area">
                    <div>
                      <input name="comment" id="commentInput" class="comment-input" type="text" placeholder="댓글 달기..." autocomplete="off" value = ""/>
