...
-- 관련 있는 계정 조회(정확도 순)
SELECT MEMBER_PROFILE_IMG, MEMBER_NICKNAME, MEMBER_NAME
FROM "MEMBER" 
WHERE SECESSION_FL = 'N'
AND (MEMBER_NICKNAME LIKE '%피에스타%'
...
-- 인기게시글
SELECT * FROM (SELECT B.BOARD_NO, BOARD_CREATE_DATE,
...
-- BOARD_IMG 사진 샘플 추가
INSERT INTO BOARD_IMG 
VALUES(SEQ_IMG_NO.NEXTVAL, 1, '/resources/images/board/', '샘플 이미지', '뷔.jpg', '202211190010.jpg', 2);
