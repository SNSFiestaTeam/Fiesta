...
FROM "MEMBER"
WHERE (MEMBER_NICKNAME LIKE '%유%' 
	OR MEMBER_NICKNAME LIKE '%UPPER(유)%'  
	OR MEMBER_NICKNAME LIKE '%LOWER(유)%')
OR (MEMBER_NAME LIKE '%유%' 
	OR MEMBER_NAME LIKE '%UPPER(유)%' 
	OR MEMBER_NAME LIKE '%LOWER(유)%')
