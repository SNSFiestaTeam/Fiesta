...
COMMENT_CREATE_DATE , UPPER_COMMENT_NO , BOARD_NO,
(SELECT MEMBER_NICKNAME
FROM "MEMBER" m
WHERE c.COMMENT_MEMBER_NO = m.MEMBER_NO) MEMBER_NICKNAME
FROM "COMMENT" c
WHERE BOARD_NO = 10
ORDER BY COMMENT_NO

SELECT b.BOARD_NO , BOARD_CONTENT , BOARD_PUB_PRI_FL , COMMENT_BLOCK_FL , b.MEMBER_NO,  
CASE 
	...
	ELSE TO_CHAR(BOARD_CREATE_DATE , 'MM"월" DD"일"')
